...
Person.prototype = {
		...
		update : function(){//更新
			...
			if(this.life<30){document.querySelector("#js_life").style.backgroundColor="red";}
			else 
			if(this.life>=30&&this.life<60){document.querySelector("#js_life").style.backgroundColor="yellow";}
            else{document.querySelector("#js_life").style.backgroundColor="greenyellow";}
...
//				x = -30;
			...
			//小人 超出右边界
			if(f_size.r >= this.pinfo.w+32){
//				x = this.pinfo.w+30 - f_size.w;
                x=0;
			}
